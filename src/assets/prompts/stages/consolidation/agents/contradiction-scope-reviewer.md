...
Do not call write_workspace_memory, write_global_memory, remove_memory, or finalize_consolidation. Return an action plan for the main consolidation agent and reference-validator.
